...
class APSFUnmixingNet(nn.Module):
    ...
    def forward(self, image: Tensor, return_aux: bool = False) -> dict[str, Tensor | dict[str, Tensor]]:
        ...
        public: dict[str, Tensor | dict[str, Tensor]] = {
            ...
            "R": crop(residual),
            # Public U has one supervised meaning: normalized reconstruction
            # error.  PSF selection entropy remains available as an auxiliary
            # diagnostic instead of silently changing that meaning.
